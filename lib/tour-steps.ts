...
export const responsiveTourSteps: Record<TourId, ResponsiveStep[]> = {
  admin: [
    ...
    },
    {
      ...
      title: "Urunler",
      content: "Urunlerini burdan yonet.",
      desktopPlacement: "right",
    },
    {
      desktop: '[data-tour="nav-desenler"]',
      title: "Desenler",
      content: "Nakis desenlerini burdan yonet.",
      desktopPlacement: "right",
    },
    {
      desktop: '[data-tour="nav-kategoriler"]',
      title: "Kategoriler",
      content: "Nakis, dantel, bohca gibi kategorilerin.",
      desktopPlacement: "right",
    },
    {
      desktop: '[data-tour="nav-blog"]',
      title: "Blog",
      content: "Siteye yazi ekle burdan.",
      desktopPlacement: "right",
    },
    {
      desktop: '[data-tour="nav-gorsel"]',
      title: "Gorsel Olustur",
      content: "Yapay zeka ile urun gorseli olustur.",
      desktopPlacement: "right",
    },
    {
      desktop: '[data-tour="nav-instagram"]',
      title: "Instagram",
      content: "Instagram paylasimlarini siteye aktar.",
      desktopPlacement: "right",
    },
    {
      desktop: '[data-tour="nav-ayarlar"]',
      title: "Ayarlar",
      content: "Site ayarlarini degistir.",
      desktopPlacement: "right",
    },
    {
    ...
    },
    {
      ...
      title: "Yardim Butonu",
      content: "Unutursan buraya bas anne, tekrar gostereyim!",
      desktopPlacement: "top",
    },
  ],

...
import { ArrowLeft, Upload, X, Loader2, Link2 } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Yeni Desen</h1>
          <p className="text-sm text-muted-foreground">
            Yeni bir nakis deseni olusturun
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="glass-card rounded-3xl p-6 space-y-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <label className="flex cursor-pointer flex-col items-center justify-center rounded-3xl border-2 border-dashed border-border/50 p-6 transition-colors hover:border-primary/30 hover:bg-muted/30 flex-1">
